...
{
    public partial class ListadoProfesionalEdicion : Form
    {
        public ListadoProfesionalEdicion()
        {
            InitializeComponent();
        }
        ...
        {
            ModificacionProfesional formModificarProfesional = new Clinica_Frba.Abm_de_Profesional.ModificacionProfesional();
            formModificarProfesional.pk_medico = dataGridView1.CurrentRow.Cells[1].Value.ToString();
            DialogResult result = formModificarProfesional.ShowDialog();
